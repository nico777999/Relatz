...
export default function Editor({ elements, setElements }) {
            ...
            [
                {
                    ...
                    rows: [
                        [{ content: "", bgColor: "#FFFFFF" }, { content: "", bgColor: "#FFFFFF" }],
                        [{ content: "", bgColor: "#FFFFFF" }, { content: "", bgColor: "#FFFFFF" }]
                    ]
                },
    ...
    const getNode = useCallback((parent, historyIndex) => {
    ...
    const handleSetElement = useCallback((updatedElement, index) => {
    ...
    const handleSetDisplayedElements = useCallback((childElements, childIndex) => {
        const newHistory = [...history];
            ...
            <div className="w-full h-96 py-4 px-1.5 border-x-2 border-[#ACACAC] overflow-y-scroll">
                {displayedElements.map((element, index) => (
                    <DisplayElement
                        ...
                        setDisplayedElements={handleSetDisplayedElements}
                    />
                ))}
            </div>
